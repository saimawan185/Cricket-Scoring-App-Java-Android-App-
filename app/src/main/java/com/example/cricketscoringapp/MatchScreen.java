...
//    private int totalRuns=0, totalWickets=0, team1TotalRuns=0, team2TotalRuns=0;
...
//
//        team1Ballers = new ArrayList<PlayerModel>();
//        team2Ballers = new ArrayList<PlayerModel>();
//
...
//    {
//        String player = playerOneName;
//        int runs = playerOneRuns;
...
//    {
//        if(overs==Double.valueOf(numberOfOvers))
//        {
//            if(firstTeamPlayed)
//            {
//                if(playingTeam==1)
//                {
//                    if(team2TotalRuns>totalRuns)
//                    {
//                        showDialogBox("Success","Team 2 Won!");
//                    }
//                    else if(team2TotalRuns<totalRuns) {
//                        showDialogBox("Success","Team 1 Won!");
//                    }
//                    else {
//                        showDialogBox("Success","Match Withdrawn!");
//                    }
//                }
//                else {
//                    if(team1TotalRuns>totalRuns)
//                    {
//                        showDialogBox("Success","Team 1 Won!");
//                    }
//                    else if(team1TotalRuns<totalRuns) {
//                        showDialogBox("Success","Team 2 Won!");
//                    }
//                    else {
//                        showDialogBox("Success","Match WWithdrawn!");
//                    }
//                }
//            }
//            else {
...
//                    playingTeam =1;
//                }
//                showDialogBox("","Total Runs: "+totalRuns);
...
//        ballerOverviewText.setText(String.valueOf(ballerOvers)+" ("+String.valueOf(ballerRuns)+") "+String.valueOf(ballerWickets));
...
public class MatchScreen extends AppCompatActivity {
    ...
    private void checkOverComplete() {
        if (overs == numberOfOvers || totalWickets >= firstTeamPlayers.size()) {
            if (firstTeamPlayed) {
                showMatchResult(); // Show result when the second team finishes
            } else {
                firstTeamPlayed = true;
                saveFirstInningsData(); // Save first innings data
    ...
    private void saveFirstInningsData() {
        if (playingTeam == 1) {
            team1TotalRuns = totalRuns;
            targetScoreText.setText("Target: " + (team1TotalRuns + 1));
        } else {
            team2TotalRuns = totalRuns;
            targetScoreText.setText("Target: " + (team2TotalRuns + 1));
        }
    }
